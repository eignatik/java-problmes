 ...
 *
 * <p>The approximate algorithm complexity is O(m*(m-n)) in best case, and O(m*n) in the worst
 * case, where m is a size of source string and n is a size of the target string.
 */
